//
//  MessageTwoPhotoTextTableViewCell.swift
//  MaruTalk
//
...
final class MessageTwoPhotoTextTableViewCell: BaseTableViewCell {
    ...
    private let photoHStackView: UIStackView = {
        let stackView = UIStackView()
    ...
    override func configureHierarchy() {
        ...
        photoHStackView.addArrangedSubview(firstPhotoImageView)
        photoHStackView.addArrangedSubview(secondPhotoImageView)
        
        stackView.addArrangedSubview(usernameLabel)
        stackView.addArrangedSubview(messageBodyBackView)
        messageBodyBackView.addSubview(messageBodyLabel)
        stackView.addArrangedSubview(photoHStackView)
