...
final class MessageFivePhotoTextTableViewCell: BaseTableViewCell {
    ...
    let fifthPhotoImageView: UIImageView = {
        let iv = UIImageView()
        iv.contentMode = .scaleAspectFill
        iv.layer.cornerRadius = 12
    ...
    override func configureLayout() {
        ...
        fourthPhotoImageView.snp.makeConstraints { make in
            make.top.equalTo(firstPhotoImageView.snp.bottom).offset(2)
            make.leading.equalTo(firstPhotoImageView)
        ...
        fifthPhotoImageView.snp.makeConstraints { make in
            make.top.equalTo(firstPhotoImageView.snp.bottom).offset(2)
            make.leading.equalTo(fourthPhotoImageView.snp.trailing).offset(2)
            make.width.equalTo(121)
            make.height.equalTo(80)
        }
