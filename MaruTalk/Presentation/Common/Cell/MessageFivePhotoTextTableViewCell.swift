//
//  MessageFivePhotoTextTableViewCell.swift
//  MaruTalk
//
...
final class MessageFivePhotoTextTableViewCell: BaseTableViewCell {
    ...
    private let fifthPhotoImageView: UIImageView = {
        let iv = UIImageView()
        iv.contentMode = .scaleAspectFill
        iv.layer.cornerRadius = 12
    ...
    override func configureHierarchy() {
        ...
        firstPhotoHStackView.addArrangedSubview(thirdPhotoImageView)
        secondPhotoHStackView.addArrangedSubview(fourthPhotoImageView)
        secondPhotoHStackView.addArrangedSubview(fifthPhotoImageView)
    ...
    override func configureLayout() {
        ...
        fifthPhotoImageView.snp.makeConstraints { make in
            make.width.equalTo(121)
            make.height.equalTo(80)
        }
    }
    ...
    func configureCell(data: RealmChannelChat) {
        ...
        let imageViewList = [firstPhotoImageView, secondPhotoImageView, thirdPhotoImageView, fourthPhotoImageView, fifthPhotoImageView]
